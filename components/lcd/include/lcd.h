...
// Brings up the SPI bus, panel IO and panel driver — which panel driver
// (ST7789 / ILI9341 / ST7796) is picked at compile time from the
// BOARD_CYD_* define in board_config.h, not from anything in `config`.
